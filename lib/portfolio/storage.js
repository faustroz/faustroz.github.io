...
const KEYS = {
  ...
  MARKET_PRICES: 'pt_market_prices',
...
// ---- Last known market quotes (private fallback during provider outages) ----
export const getMarketPrices = () => read(KEYS.MARKET_PRICES, {});
export const setMarketPrices = (prices) => write(KEYS.MARKET_PRICES, prices);
