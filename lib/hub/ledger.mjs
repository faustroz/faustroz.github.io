...
export function filterAndSortLedger(records, { dateField, amountField = "amount", month = "all", sort = "date-desc" }) {
  const visible = month === "all" ? records : records.filter((record) => String(record[dateField] || "").startsWith(month));
