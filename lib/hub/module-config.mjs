export const FINANCE_CHANNELS = Object.freeze([
  {
    ...
    fields: [
      ...
      { name: "category", label: "Category", type: "lookup", lookup: { table: "finance_categories", value: "name", label: ["name", "kind"], kinds: ["income", "both"] }, defaultValue: "", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "amount", label: "Amount", type: "number", format: "currency", min: 0, required: true },
      { name: "category", label: "Category", type: "lookup", lookup: { table: "finance_categories", value: "name", label: ["name", "kind"], kinds: ["expense", "both"] }, defaultValue: "", required: true },
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Expense category", type: "lookup", lookup: { table: "finance_categories", value: "name", label: ["name", "kind"], kinds: ["expense", "both"] }, defaultValue: "", required: true },
