export const FINANCE_CHANNELS = Object.freeze([
  ...
  {
    id: "income", label: "Income", table: "income_entries", title: "Income ledger", orderBy: "received_on", ledger: { dateField: "received_on", amountField: "amount" },
  ...
  {
    id: "expenses", label: "Expenses", table: "expenses", title: "Expense ledger", orderBy: "spent_on", ledger: { dateField: "spent_on", amountField: "amount" },
