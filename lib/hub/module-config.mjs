export const FINANCE_CHANNELS = Object.freeze([
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "bank_account_id", label: "Paid from (bank/account)", type: "lookup", lookup: { table: "bank_accounts", value: "id", label: ["bank_name", "name", "account_type"] }, defaultValue: "", optional: true },
