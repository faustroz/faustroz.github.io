...
export const ACADEMIC_CHANNELS = Object.freeze([
  { id: "records", label: "Academic record", table: "academic_records", title: "Grades & credits", orderBy: "updated_at", description: "Record grade, credits/SKS, semester, and block. IP/IPK is calculated from these private records.", fields: [
    { name: "course_name", label: "Course", required: true }, { name: "credits", label: "SKS", type: "number", min: 0.5, required: true }, { name: "grade", label: "Grade", type: "select", options: ["A","A-","B+","B","B-","C+","C","D","E"], defaultValue: "A" }, { name: "semester", label: "Semester", required: true }, { name: "block", label: "Block", defaultValue: "" },
  ] },
]);
