...
export const SEARCH_SOURCES = Object.freeze([
  ...
  { group: "Study", label: "Academic", table: "academic_records", route: "/academic", fields: ["course_name", "semester", "block", "grade"], primary: "course_name", secondary: ["semester", "grade"] },
...
const GROUP_ORDER = ["Finance", "Study", "Projects", "Documents"];
