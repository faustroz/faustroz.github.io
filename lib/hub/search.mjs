...
export const SEARCH_SOURCES = Object.freeze([
  ...
  { group: "Finance", label: "Transfer", table: "bank_transfers", route: "/finance", channel: "transfers", fields: ["notes", "transferred_on"], primary: "transferred_on", secondary: ["notes"] },
  { group: "Finance", label: "Reconciliation", table: "bank_account_reconciliations", route: "/finance", channel: "reconciliation", fields: ["notes", "reconciled_on"], primary: "reconciled_on", secondary: ["notes"] },
  ...
  { group: "Academic", label: "MKU", table: "academic_mku_records", route: "/academic", fields: ["course_name", "semester", "grade"], primary: "course_name", secondary: ["semester"] },
