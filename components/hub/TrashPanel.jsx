...
const tables = [["expenses", "Expenses"], ["income_entries", "Income"], ["bank_transfers", "Transfers"], ["bank_account_reconciliations", "Reconciliation"], ["financial_goals", "Goals"], ["bank_accounts", "Balances"], ["finance_categories", "Categories"], ["budgets", "Budgets"], ["subscriptions", "Subscriptions"], ["academic_records", "Academic"], ["academic_mku_records", "MKU"], ["vault_documents", "Vault"]];
