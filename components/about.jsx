    ...
    <section id="about" className="py-16 md:py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-16">
          {skills.map((skill) => (
            <div key={skill.title} className="text-center p-6 rounded-2xl bg-gray-50 shadow-sm hover:shadow-md transition-shadow">
              <div className="text-gray-700 mb-4 flex justify-center">{skill.icon}</div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">{skill.title}</h3>
