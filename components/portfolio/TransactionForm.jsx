...
export default function TransactionForm({ initialAsset, editTx, onSave, onClose }) {
  ...
  const validate = () => {
    ...
    if (!form.units || parseFloat(form.units) <= 0) errs.units = 'Jumlah unit harus > 0';
    if (!form.buyPrice || parseFloat(form.buyPrice) <= 0) errs.buyPrice = 'Harga harus > 0';
  ...
  return (
    <div className="pt-modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="pt-modal">
        ...
        <div className="pt-modal-body">
          ...
          <div className="pt-type-toggle">
            ...
            >
              <TrendingUp size={14} style={{ transform: 'rotate(180deg)' }} /> Jual
            </button>
          </div>
          ...
          <div className="pt-form-grid">
            ...
            <div className="pt-input-group">
              ...
              />
              {errors.assetName && <span className="pt-error">{errors.assetName}</span>}
            </div>
            ...
            <div className="pt-input-group">
              ...
              />
              {errors.ticker && <span className="pt-error">{errors.ticker}</span>}
            </div>
            ...
            {isCrypto && (
              <div className="pt-input-group full">
                ...
                />
                {errors.coinGeckoId && <span className="pt-error">{errors.coinGeckoId}</span>}
            ...
            <div className="pt-input-group">
              ...
              />
              {errors.units && <span className="pt-error">{errors.units}</span>}
            </div>
            ...
            <div className="pt-input-group">
              <label className="pt-label">
                <DollarSign size={13} />
                {form.type === 'sell' ? 'Harga Jual (per unit)' : 'Harga Beli (per unit)'}
              </label>
              <input
                type="number"
            ...
            <div className="pt-total-estimate">
              ...
              <span className="mono">
                {new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(
                  parseFloat(form.units || 0) * parseFloat(form.buyPrice || 0) + parseFloat(form.brokerFee || 0)
                )}
              </span>
            </div>
          )}
        ...
        <div className="pt-modal-footer">
          <button className="pt-btn-ghost" onClick={onClose}>Batal</button>
