...
export default function StudyPage() {
  return (
    <main className="hub-private-page">
      <header className="hub-private-heading hub-reveal"><span>02 / STUDY SYSTEM</span><h1>Learning operations.</h1><p>Topics, exams, recall material, and progress in one private command surface.</p></header>
